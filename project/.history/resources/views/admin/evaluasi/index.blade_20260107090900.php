...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('admin.evaluasi.create') }}" class="btn btn-primary shadow-sm">
                    ...
                    <tbody>
                        @foreach ($evaluasi as $index => $item)
                            <tr>
                                ...
                                <td>{{ $item->tanggal }}</td>
                                <td>{{ $item->penulisRelation->nama ?? $item->penulis }}</td>
                                ...
                                <td class="text-center btn-action">
                                    ...
                                    <a href="{{ route('admin.evaluasi.show', $item->id) }}" class="btn btn-sm btn-info">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.evaluasi.edit', $item->id) }}" class="btn btn-sm btn-warning">
