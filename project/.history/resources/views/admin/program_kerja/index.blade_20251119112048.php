...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('admin.program_kerja.create') }}" class="btn btn-primary shadow-sm">
                        ...
                        @foreach ($programKerja as $p)
                            <tr>
                                ...
                                <td class="text-center btn-action">
                                    <a href="{{ route('admin.program_kerja.show', $p->id) }}" class="btn btn-sm btn-info"><i
                                            class="bi bi-eye"></i></a>
                                    <a href="{{ route('admin.program_kerja.edit', $p->id) }}" class="btn btn-sm btn-warning"><i
                                    ...
                                    <div class="modal fade" id="modalDelete{{ $p->id }}" tabindex="-1"
                                        aria-labelledby="modalDeleteLabel{{ $p->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content border-0 shadow-sm">
                                                ...
                                                <div class="modal-body text-center text-muted">
                                                    Data <strong>{{ $p->nama }}</strong> akan dihapus secara permanen.
                                                </div>
                                                ...
                                                <div class="modal-footer border-0 justify-content-center pb-4 gap-2">
                                                    ...
                                                    <form action="{{ route('admin.program_kerja.destroy', $p->id) }}"
